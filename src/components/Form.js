...
function Form() {
  return (
    <div className='bg-white px-10 py-10 rounded-3xl border-2 border-[#FFF4CF]'>
        ...
        <p className='font-normal text-gray-500 mt-2'>Welcome! Please enter your details.</p>
        <div className='mt-8'>
            <div>
            ...
            <div className='mt-2 flex justify-end'>
                <button className='font-medium text-sm text-[#277BC0]' onClick={() => window.location.href = "#"}>
                    Forgot Password?
                </button>
            </div>
